...
<body>
    <form method="post">
        ...
        <input type="radio" name="darisuhu" value="Rheamur">Rheamur</br>
        ...
        <input type="radio" name="kesuhu" value="Rheamur">Rheamur</br>
...
if (isset($_POST["submit"])) {
    ...
    if(isset($_POST['suhu']) && isset($_POST['darisuhu']) && isset($_POST['kesuhu'])) {
        $suhu = $_POST['suhu'];
    ...
    if ($darisuhu == "Celcius") {
        if ($kesuhu == "Celcius") {
            ...
            if ($kesuhu == "Celcius") {
                ...
                echo "<h2>Hasil Konversi: " . (($suhu * 5 / 4) + 273.15) . " &deg;K</h2>";
            }
            ...
            if ($kesuhu == "Celcius") {
                ...
                echo "<h2>Hasil Konversi: " . (($suhu - 273.15) * 4 / 5) . " &deg;R</h2>";
            } elseif ($kesuhu == "Kelvin") {
